...
async def main():
    ...
    output_pdf = os.path.expanduser(args.output) if args.output else os.path.expanduser(f"~/Downloads/{company_name}-行政处罚文书网-{date_str}.pdf")
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.evaluate(f"document.querySelector('#keyword').value = '{company_name}'")
