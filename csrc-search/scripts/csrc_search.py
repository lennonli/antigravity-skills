...
async def main():
    ...
    parser.add_argument("id_num", nargs='?', default="110000000000000000")
    ...
    async with async_playwright() as p:
        ...
        print("Filling form...")
        await page.evaluate(f"document.querySelector('input[placeholder*=\"必须填写姓名\"]').value = '{name}'")
        await page.evaluate(f"document.querySelector('input[placeholder*=\"需要填写完整\"]').value = '{id_num}'")
